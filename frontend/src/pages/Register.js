    ...
    <>
      <Container>
        <Snackbar
          ...
          onClose={AcountCreated}
        >
          <Alert onClose={AcountCreated} severity="success">
            Account Created Successfully, Please <strong>LOGIN</strong>
          </Alert>
        </Snackbar>
        <Snackbar open={passCheck} autoHideDuration={2000} onClose={passHandle}>
          <Alert onClose={passHandle} severity="warning">
            Please Fill All the <strong>DETAILS</strong>
          </Alert>
        </Snackbar>
        <Snackbar
          open={Passwordvalid}
          autoHideDuration={5000}
          onClose={passwordChecker}
        >
          <Alert onClose={passwordChecker} severity="warning">
